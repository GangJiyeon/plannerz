                ...
                <c:if test="${newUserInfo != null}">
                    <form:form method="get">
                        <div class="welcome">
                            ...
                            <div>회원님의 비밀번호는 ${newUserInfo.user_pw}입니다. </div>
                        </div>
                        <div>
                        ...
                        <div>
                            <button type="submit" onclick="javascript:form.action='/Z/view/find/id'" id="">아이디 찾기</button>
                        </div>
                    </form:form>
                </c:if>
